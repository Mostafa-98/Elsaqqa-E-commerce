...
const Login = () => {
  ...
  async function forgotPassword(email) {
    try {
      ...
      toast.error("Error from forgot password");
      console.log(error, "error from forgot Pass");
    }
  }
  ...
  return (
    ...
    <div className="w-full">
      ...
      <div className="grid container w-full  mt-8 grid-cols-1 md:grid-cols-2 gap-4  mx-auto  ">
          ...
          <div className=" w-full h-full flex justify-center align-middle">
            <div className=" flex flex-col justify-center align-middle   p-6   border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
              <div className="flex flex-row">
                <img src={logo} className="w-12 p-2 " alt="" />
          ...
          <div className=" ">
            <div className="w-full mx-auto ">
              <div className="flex flex-row">
                <img src={logo} className="w-12 p-2 " alt="" />
                <NavLink to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                  <span className="self-center text-[#0B50B9] text-4xl font-bold whitespace-nowrap dark:text-white">ELSAQA</span>
                </NavLink>
              </div>
              <h1 className="text-3xl text-[#0B50B9] font-bold mt-3 mb-3">Welcome back</h1>
              <p className="mt-2 mb-3">Start your website in seconds. Don’t have an account? <NavLink className="text-blue-600 hover:underline" to={"/register"}>Sign up.</NavLink> </p>
              <form onSubmit={formik.handleSubmit} className="space-y-5">
                ...
                <div className="flex items-start">
                  <div className="flex justify-between w-[90%] mx-auto">
                    ...
                    <div>
                      <Link to={"/resetpassword"} onClick={() => forgotPassword(formik.values.email)} className="text-blue-700">
                        Forgot password?
                      </Link>
                    </div>
                  </div>
                ...
                <button type=" submit " className="text-white w-full bg-[#0B50B9] hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-[#0B50B9] dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                  {isLoading ? <i className="fa-solid fa-spin fa-spinner text-white"> </i> : "Sign in to your account"}
                </button>
              </form>
            </div>
          </div>
