...
const Payment = () => {
    ...
    async function CashOrder() {
        ...
        try {
            ...
            console.log(error, "error from payment from cart context ");
            ...
            <div className="w-full">
                ...
                <div className="grid container w-full  grid-cols-1 md:grid-cols-2 gap-4  mx-auto  ">
                    ...
                    <div className=" bg-white    sm:p-6 dark:bg-gray-800 dark:border-gray-700">
                        <div className=" ">
                            <h1 className="text-[#0B50B9] text-2xl font-bold text- mb-5">Check Out</h1>
                            ...
                            <div className="w-full mx-auto ">
                                ...
                                <div className="relative z-0 w-full mb-5 group">
                                    ...
                                    <label htmlFor="details" className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-[#0B50B9] peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Details</label>
                                </div>
                                ...
                                <div className="relative z-0 w-full mb-5 group">
                                    ...
                                    <label htmlFor="city" className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-[#0B50B9] peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Your Country</label>
                                </div>



                                <button onClick={CashOrder} className="text-white w-full bg-[#0B50B9] hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-[#0B50B9] dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                                    <i className="fa-regular fa-money-bill-1 h-4 me-2 -ms-1 w-7"></i>
                                    {loading ? <i className="fa-solid fa-spin fa-spinner text-white"></i> : "Cash Payment"}

                                </button>

                                <button onClick={OnlineOrder} type="button" className="text-center justify-center  w-full border text-white bg-[#0B50B9]  hover:bg-blue-800  focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-20 py-2.5  inline-flex items-center dark:focus:ring-[#050708]/50 dark:hover:bg-[#050708]/30 me-2 mb-2">
